...
and vtiger_defectoscf.cf_894 like '".$depto."' and cf_862 like '%Cobertura de Prueba:%'
...
";*/
	...
	$string = "$(function () {
    Highcharts.chart('causaRaiz_CoberturaDePrueba', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Total de Defectos por causa raiz \" Cobertura de Prueba \" '
        },
        subtitle: {
            text: ''
        },
